...
export const LemonSelect: React.FC<LemonSelectProps> = ({
  ...
  return (
    <select
      ...
      disabled={disabled}
      className={cn(
        'appearance-none w-full px-4 py-2.5 text-sm rounded-xl border border-gray-200/60',
        'bg-lemonade-bg dark:bg-white/[0.06] dark:border-white/[0.08] dark:text-white',
        ...
        'pr-10 transition-all duration-200 outline-none',
